...
df = DataHandler.DataHandler(excel_file="data/Population.xlsx",number_of_frames= 100*0.5*60).df
...
canvas.add_title('EVOLUTION OF POPULATION ',color=(0,0,225))


canvas.add_sub_title(text="From 1950 to 2020",color=(0,255,0))
